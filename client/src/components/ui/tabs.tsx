...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-white text-muted-foreground inline-flex gap-2 h-10 w-fit items-center justify-center rounded-xl p-[6px]",
        className,
      )}
      {...props}
    />
